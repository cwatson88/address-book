        ...
        <div className="modal-dialog modal-dialog-centered" role="document">
          <div className="modal-content">
            <div className="modal-header">
              <img alt="profile pic" src={contactDetails.picture} />
              <h5 className="modal-title" id="exampleModalLongTitle">
                {contactDetails.name}
              </h5>
              <span>
                {// if the person is active then show a green dot if not show a red one
                contactDetails.isActive ? <span className="contact-online">
                    <i class="material-icons">notifications</i> <br />Online
                  </span> : <span className="contact-offline">
                    <i class="material-icons">notifications_off</i> <br />Offline
                  </span>}
              </span>
            ...
            <div className="modal-body">
              <p>
                ...
                <b>
                  Age:
                </b> <br /> <span className="contact__details">
                  {contactDetails.age}
                </span>
              </p>
              <p>
              ...
              <p>
                ...
                <b>Phone:</b> <br /> <span className="contact__details">
              ...
              <p>
                ...
                <b>Registered:</b> <br /> <span className="contact__details">
                  {<span>
                      on - <i>{formatDate(contactDetails.registered).date}</i> at: <i
                      >
                        {formatDate(contactDetails.registered).time}
                      </i>
                    </span>}
                </span>
              </p>
              <p>
                ...
                <b>LatLong: </b> <br />
                <GoogleMap coordinates={[contactDetails.latitude, contactDetails.longitude]} />
              </p>
              <p>
